...
public class Users {
    ...
    public Users(BigDecimal id, String name, String password, String xm, String xb, String ywm, String zw, BigDecimal bmid, String ssbm, BigDecimal jsid, String jsmc, String sjhm, String yx, String zzzt, String zt, String createBy, String updateBy, Date createTime, Date updateTime) {
        this.id = id;
        this.name = name;
